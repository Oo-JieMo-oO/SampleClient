...
import vip.radium.event.impl.render.framebuffer.FrameBufferResizeEvent;
import vip.radium.event.impl.world.TickEvent;
import vip.radium.event.impl.world.WorldLoadEvent;
import vip.radium.module.impl.misc.MemoryFix;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void createDisplay() throws LWJGLException {
        ...
        Display.setTitle("Sample - Minecraft 1.8.9");
