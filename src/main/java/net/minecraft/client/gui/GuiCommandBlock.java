...
public class GuiCommandBlock extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        this.commandTextField = new GuiTextField(2, FontLoaders.F17, this.width / 2 - 150, 50, 300, 20);
        this.commandTextField.setMaxStringLength(32767);
        this.commandTextField.setFocused(true);
        this.commandTextField.setText(this.localCommandBlock.getCommand());
        this.previousOutputTextField = new GuiTextField(3, FontLoaders.F17, this.width / 2 - 150, 150, 276, 20);
