...
public abstract class GuiScreen extends Gui implements GuiYesNoCallback {
    ...
    public void handleMouseInput() throws IOException {
        int i;
        int j;
        if (this instanceof SkeetUI) { // TODO: SkeetUI LockedResolution
            i = Mouse.getEventX() / 2;
            j = RenderingUtils.getLockedResolution().getHeight() - Mouse.getEventY() / 2 - 1;
        } else {
            i = Mouse.getEventX() * this.width / this.mc.displayWidth;
