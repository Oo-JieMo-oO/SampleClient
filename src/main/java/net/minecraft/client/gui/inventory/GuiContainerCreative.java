...
public class GuiContainerCreative extends InventoryEffectRenderer
{
    ...
    public void initGui()
    {
        if (this.mc.playerController.isInCreativeMode())
        {
            ...
            this.searchField = new GuiTextField(0, FontLoaders.F18, this.guiLeft + 82, this.guiTop + 6, 89, this.fontRendererObj.FONT_HEIGHT);
    ...
    protected void drawGuiContainerBackgroundLayer(float partialTicks, int mouseX, int mouseY)
    {
        ...
        {
            Gui.drawTexturedModalRect(i, j + (int)((float)(k - j - 17) * this.currentScroll), 232 + (this.needsScrollBars() ? 0 : 12), 0, 12, 15);
        }
    ...
    protected void func_147051_a(CreativeTabs p_147051_1_)
    {
        ...
        GlStateManager.disableLighting();
        Gui.drawTexturedModalRect(l, i1, j, k, 28, j1);
        this.zLevel = 100.0F;
