...
public class GuiChat extends GuiScreen {
    ...
    private void sendAutocompleteRequest(String p_146405_1_, String p_146405_2_) {
        if (p_146405_1_.length() >= 1) {
            ...
            this.mc.thePlayer.sendQueue.sendPacket(new C14PacketTabComplete(p_146405_1_, blockpos));
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        drawRect(2, this.height - 14, Math.max(GuiNewChat.calculateChatboxWidth(mc.gameSettings.chatWidth) + 5, fontRendererObj.getStringWidth(inputField.getText()) + 7), this.height - 2, Integer.MIN_VALUE);
